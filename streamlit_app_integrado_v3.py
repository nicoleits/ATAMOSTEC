...
try:
    # Importar y ejecutar el dashboard integrado v3
    import dashboard_integrado_v3

    # El dashboard se ejecuta automáticamente al importar el módulo

except Exception as e:
    st.error(f"❌ Error al cargar el dashboard integrado v3: {str(e)}")
    ...
    st.warning("⚠️ El dashboard integrado v3 no pudo cargarse completamente.")
