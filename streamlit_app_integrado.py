...
try:
    # Importar y ejecutar el dashboard integrado
    import dashboard_integrado
    
    # El dashboard se ejecuta automáticamente al importar el módulo
    
except Exception as e:
    st.error(f"❌ Error al cargar el dashboard integrado: {str(e)}")
    ...
    st.warning("⚠️ El dashboard integrado no pudo cargarse completamente.")
