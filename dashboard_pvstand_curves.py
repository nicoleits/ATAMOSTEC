...
@st.cache_data
def load_data():
    """Carga los datos de curvas IV de PVStand."""
    try:
        file_path = "/home/nicole/SR/SOILING/datos/raw_pvstand_curves_data.csv"
        if os.path.exists(file_path):
            ...
            st.info("💡 Asegúrate de haber ejecutado la función download_pvstand_curves primero")
            return None
